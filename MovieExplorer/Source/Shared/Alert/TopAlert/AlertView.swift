...
class AlertView: UIView {
    ...
    @IBOutlet weak var indeicatorView: UIView!
    ...
    private func setupBlur() {
        self.alertView.backgroundColor = .secondarySystemGroupedBackground
    }
    ...
    func set(message: String, type: AlertType) {
        ...
        self.alertLabel.textColor = .label
        self.indeicatorView.backgroundColor = type.indicatorColor
        self.imageView.image = UIImage(systemName: type.image)
